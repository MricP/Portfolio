        ...
        <div class="grid lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              <a v-for="(preuve, idx) in mission.preuves" :key="idx" :href="preuve.link" class="flex items-center gap-5 bg-white hover:bg-gray-50 border border-[#d9d9d9] hover:border-[#A9A9FF] rounded-2xl p-5 transition-all duration-300 group cursor-pointer hover:-translate-y-1 hover:shadow-md">
